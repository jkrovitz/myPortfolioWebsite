$(function() {
  ...
  $(window).on('scroll', function () {
    ...
    if (pos2 > $('#software-projects').offset().top)       { highlightLink('software-projects'); }
    if (pos2 > $('#gis-projects').offset().top)       { highlightLink('gis-projects'); }
    if (pos2 > $('#contact').offset().top) {highlightLink('contact');}
    // if (pos2 > $('#contact').offset().top ||
    //     pos2 + $(window).height() === $(document).height()) {
  ...
  $('#contact-form').submit(function(e) {
    e.preventDefault();
      ...
      $.ajax({
          url: "https://formspree.io/jeremy@jeremykrovitz.com",
          method: "POST",
